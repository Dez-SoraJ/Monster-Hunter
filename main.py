...
class Game:
	...
	def import_assets(self):
		self.tmx_maps = tmx_importer('..', r"C:\Users\ADMIN\Desktop\Monster Hunter\data\maps")

		self.overworld_frames = {
			'water': import_folder('..', r"C:\Users\ADMIN\Desktop\Monster Hunter\graphics\tilesets\water"),
			'coast': coast_importer(24, 12, '..', r"C:\Users\ADMIN\Desktop\Monster Hunter\graphics\tilesets\coast"),
			'characters': all_character_import('..', r"C:\Users\ADMIN\Desktop\Monster Hunter\graphics\characters")
		}

		self.monster_frames = {
			'icons': import_folder_dict('..', r"C:\Users\ADMIN\Desktop\Monster Hunter\graphics\icons"),
			'monsters': monster_importer(4,2,'..', r"C:\Users\ADMIN\Desktop\Monster Hunter\graphics\monsters"),
			'ui': import_folder_dict('..', r"C:\Users\ADMIN\Desktop\Monster Hunter\graphics\ui"),
			'attacks': attack_importer('..', r"C:\Users\ADMIN\Desktop\Monster Hunter\graphics\attacks")
		}
		self.monster_frames['outlines'] = outline_creator(self.monster_frames['monsters'], 4)

		self.fonts = {
			'dialog': pygame.font.Font(join('..', r"C:\Users\ADMIN\Desktop\Monster Hunter\graphics\fonts\PixeloidSans.ttf"), 30),
			'regular': pygame.font.Font(join('..', r"C:\Users\ADMIN\Desktop\Monster Hunter\graphics\fonts\PixeloidSans.ttf"), 18),
			'small': pygame.font.Font(join('..', r"C:\Users\ADMIN\Desktop\Monster Hunter\graphics\fonts\PixeloidSans.ttf"), 14),
			'bold': pygame.font.Font(join('..', r"C:\Users\ADMIN\Desktop\Monster Hunter\graphics\fonts\dogicapixelbold.otf"), 20),
		}
		self.bg_frames = import_folder_dict('..', r"C:\Users\ADMIN\Desktop\Monster Hunter\graphics\backgrounds")
		self.start_animation_frames = import_folder('..', r"C:\Users\ADMIN\Desktop\Monster Hunter\graphics\other\star animation")
	
		self.audio = audio_importer('..', r"C:\Users\ADMIN\Desktop\Monster Hunter\audio")

...
class AllSprites(pygame.sprite.Group):
	def __init__(self):
		...
		self.offset = vector()
		self.shadow_surf = import_image('..', r"C:\Users\ADMIN\Desktop\Monster Hunter\graphics\other\shadow")
		self.notice_surf = import_image('..', r"C:\Users\ADMIN\Desktop\Monster Hunter\graphics\ui\notice")
